package com.hrc.qqapplication.slidingmenu;
...
import com.hrc.qqapplication.slidingmenu.SlidingMenu.OnClosedListener;
import com.hrc.qqapplication.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	private boolean mIsBeingDragged;//Drag 拖    /fling 扔
	...
	public interface OnPageChangeListener {
		...
		/**
		 * This method will be invoked(调用) when the current page is scrolled, either as part
		 * of a programmatically initiated smooth（光滑平稳） scroll or a user initiated touch scroll.
		 *
		 * @param position Position index of the first page currently being displayed（显示）
	 ...
	 * �̳�OnPageChangeListener�ӿڣ������Լ�������ʵ�ַ�����������ȫ����ʵ�����еķ���
	 */
